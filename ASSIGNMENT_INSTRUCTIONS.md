...
1. **Fork this repository** (`https://github.com/Git-Demo-Org-CEME/Git-GitHub-Demo-Repo`) to your personal GitHub account using the "Fork" button on GitHub.
2. Clone your fork locally using:
```bash
git clone https://github.com/<your-github-username>/Git-GitHub-Demo-Repo.git
cd Git-GitHub-Demo-Repo
```
...
> [!IMPORTANT]
> **Single PR Rule**: Create **only ONE single Pull Request** for your entire assignment submission. Do NOT open multiple PRs or close/re-open PRs. If you need to make corrections or complete remaining tasks, simply push new commits to your fork branch (`git push origin main`), and your single existing PR will update automatically!

1. Navigate to your forked repository page on GitHub (`https://github.com/<your-github-username>/Git-GitHub-Demo-Repo`).
2. Click the **Contribute** dropdown button near the top right of your file list (next to *Fetch upstream*).
3. Click **Open pull request**.
4. Verify that:
   - **Base repository**: `Git-Demo-Org-CEME/Git-GitHub-Demo-Repo` (branch: `main`)
   - **Head repository**: `<your-github-username>/Git-GitHub-Demo-Repo` (branch: `main`)
...
1. **Where to see your grade**: Go to the **Pull Requests** tab of the official instructor repository:  
   👉 [Instructor Repository Pull Requests (`Git-Demo-Org-CEME/Git-GitHub-Demo-Repo/pulls`)](https://github.com/Git-Demo-Org-CEME/Git-GitHub-Demo-Repo/pulls)
2. Open your submitted Pull Request from the list.
3. Within **~15–20 seconds** of submitting or updating your PR, `github-actions[bot]` automatically posts an **Itemized Markdown Grade Table** directly in your PR's **Conversation** thread:
   ```markdown
   ### 📊 Assignment Evaluation Results (@your-github-username)
   | Task | Status | Score | Feedback |
   | :--- | :---: | :---: | :--- |
   | Task 1: Git Config & Student Info | ✅ PASS | 15 / 15 pts | PASS: Requirement completed. |
   ...
   | TOTAL SCORE | ⚠️ PARTIAL | 70 / 100 pts | Grade: 70% |
   ```
4. **Updating your score**: If you score less than 100/100 points, simply complete the remaining tasks locally on your dev machine, commit, and push to your fork:
   ```bash
   git push origin main --tags
   git push origin --all
   ```
   Your grade table comment on the instructor repository PR will **automatically update in-place** with your new score!
